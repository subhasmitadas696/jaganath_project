...
//		if (errorStatus == 0
//				&& CommonValidator.validateFile((String) obj.get("fileDocumentaryProofofOccupancyifany"))) {
//			errorStatus = 1;
...
//		}
//		if (errorStatus == 0
//				&& CommonValidator.minLengthCheck((String) obj.get("txtFixedPriceperAcreofPurchasedLand"), 1)) {
//			errorStatus = 1;
//			errMsg = "Fixed Price per Acre of Purchased Land  minimum length should be 1";
//		}
//		if (errorStatus == 0
//				&& CommonValidator.maxLengthCheck((String) obj.get("txtFixedPriceperAcreofPurchasedLand"), 90)) {
//			errorStatus = 1;
//			errMsg = "Fixed Price per Acre of Purchased Land maxmimum length should be 90";
//		}
//		if (errorStatus == 0
//				&& CommonValidator.isSpecialCharKey((String) obj.get("txtFixedPriceperAcreofPurchasedLand"))) {
//			errorStatus = 1;
