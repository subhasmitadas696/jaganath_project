...
public class Noc_applicantValidationCheck {
...
if (errorStatus == 0 &&CommonValidator.validNumberCheck( obj.get("txtMobileNo" ).toString())){
 errorStatus = 1;
errMsg= "Mobile NoGiven Number should be valid !";}
...
if (errorStatus == 0 &&CommonValidator.emailCheck((String) obj.get("txtEmail"))){
 errorStatus = 1;
errMsg= "EmailGiven email should be valid !";}
...
if (errorStatus == 0 &&CommonValidator.isCharecterKey((String) obj.get("txtPoliceStation"))){
 errorStatus = 1;
...
errorStatus = 1;
errMsg= "Habitation/ Street No./ Landmark  minimum length should be 1";}
 if (errorStatus == 0 && CommonValidator.maxLengthCheck((String) obj.get("txtHabitationStreetNoLandmark"),90)) {
errorStatus = 1;
errMsg= "Habitation/ Street No./ Landmark maxmimum length should be 90";}
...
errMsg= "Habitation/ Street No./ Landmarkshould be SpecialCharKey !";}
 if (errorStatus == 0 && CommonValidator.minLengthCheck((String) obj.get("txtHouseNo"),1)) {
errorStatus = 1;
errMsg= "House No.  minimum length should be 1";}
 if (errorStatus == 0 && CommonValidator.maxLengthCheck((String) obj.get("txtHouseNo"),45)) {
errorStatus = 1;
errMsg= "House No. maxmimum length should be 45";}
...
if (errorStatus == 0 && CommonValidator.BlankCheckRdoDropChk(obj.get("selVillageLocalAreaName21").toString())){
 errorStatus = 1;
errMsg= "Village/ Local Area Name  should not be empty !";}
 if (errorStatus == 0 && CommonValidator.minLengthCheck((String) obj.get("txtPoliceStation22"),1)) {
errorStatus = 1;
errMsg= "Police Station  minimum length should be 1";}
 if (errorStatus == 0 && CommonValidator.maxLengthCheck((String) obj.get("txtPoliceStation22"),45)) {
errorStatus = 1;
errMsg= "Police Station maxmimum length should be 45";}
if (errorStatus == 0 &&CommonValidator.isCharecterKey((String) obj.get("txtPoliceStation22"))){
 errorStatus = 1;
errMsg= "Police Station should be a character!";}
if (errorStatus == 0 &&CommonValidator.isSpecialCharKey((String) obj.get("txtPoliceStation22"))){
 errorStatus = 1;
errMsg= "Police Stationshould be SpecialCharKey !";}
...
if (errorStatus == 0 &&CommonValidator.isEmpty( obj.get("txtHabitationStreetNoLandmark24").toString())){
 errorStatus = 1;
errMsg= "Habitation/ Street No./ Landmark  should not  be empty!";}
 if (errorStatus == 0 && CommonValidator.minLengthCheck((String) obj.get("txtHabitationStreetNoLandmark24"),1)) {
errorStatus = 1;
errMsg= "Habitation/ Street No./ Landmark   minimum length should be 1";}
 if (errorStatus == 0 && CommonValidator.maxLengthCheck((String) obj.get("txtHabitationStreetNoLandmark24"),90)) {
errorStatus = 1;
errMsg= "Habitation/ Street No./ Landmark  maxmimum length should be 90";}
if (errorStatus == 0 &&CommonValidator.isAlphaNumericKey((String) obj.get("txtHabitationStreetNoLandmark24"))){
 errorStatus = 1;
errMsg= "Habitation/ Street No./ Landmark  should be AlphaNumeric !";}
...
if (errorStatus == 0 &&CommonValidator.isEmpty( obj.get("txtHouseNo25").toString())){
 errorStatus = 1;
errMsg= "House No. should not  be empty!";}
 if (errorStatus == 0 && CommonValidator.minLengthCheck((String) obj.get("txtHouseNo25"),1)) {
errorStatus = 1;
errMsg= "House No.  minimum length should be 1";}
 if (errorStatus == 0 && CommonValidator.maxLengthCheck((String) obj.get("txtHouseNo25"),45)) {
errorStatus = 1;
errMsg= "House No. maxmimum length should be 45";}
...
errMsg= "Pin Code should not  be empty!";}
 if (errorStatus == 0 && CommonValidator.minLengthCheck((String) obj.get("txtPinCode26"),6)) {
errorStatus = 1;
errMsg= "Pin Code  minimum length should be 6";}
 if (errorStatus == 0 && CommonValidator.maxLengthCheck((String) obj.get("txtPinCode26"),6)) {
errorStatus = 1;
errMsg= "Pin Code maxmimum length should be 6";}
if (errorStatus == 0 &&CommonValidator.isNumericKey((String) obj.get("txtPinCode26"))){
 errorStatus = 1;
errMsg= "Pin Code should be Numeric!";}
